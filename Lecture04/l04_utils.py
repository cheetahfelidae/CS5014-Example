...
def plotLossFunction(x, y, title='Plot'):
    # Create a dictionary to pass to matplotlib
    # These settings make the plots readable on slides, feel free to change
    # This is an easy way to set many parameters at once
    fontsize = "30";
    ...
    res = 30
    xspace = np.linspace(-100, 100, res)
    yspace = np.linspace(-100, 100, res)
    ...
    ax.plot_surface(xx, yy, L, rstride=1, cstride=1, cmap='jet', edgecolor='none') 
